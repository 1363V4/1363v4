...
powers = {
    ...
    'bomber': ["Bomber Man", "lorsqu'un autre joueur pose une carte chiffre sur le même chiffre, il pioche <em>(permanent)</em>"],
    'chimiste': ["Le Chimiste Fou", "quand un joueur fait uno, il doit gagner un chi-fu-mi contre le chimiste fou et pioche deux cartes s'il perd <em>(permanent)</em>"],
    ...
    'musclé': ["Le Musclé", "peut doubler la valeur d'un effet <em>(activable deux fois)</em>"],
    ...
    'sonic': ["Sonic", "devient le centre de l'attention et joue entre les tours <em>(désactivable)</em>"],
